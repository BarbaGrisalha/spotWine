...
<?= GridView::widget([
    ...
    'columns' => [
        ...
        [
            ...
            'template' => '{register} {vote}',
            'contentOptions' => ['class' => 'align-middle text-center'],
            'buttons' => [
                'register' => function ($url, $model) {
                    return Html::a('<i class="fas fa-info mr-1"></i>Saber Mais', ['contest/view', 'id' => $model->id], [
                        'class' => 'btn btn-outline-info',
                    ]);
                },
                'vote' => function ($url, $model) {
                    if ($model->status === 'voting') {
                        return Html::a('<i class="fas fa-vote-yea"></i> Votar',
                            ['contest/vote', 'id' => $model->id],
